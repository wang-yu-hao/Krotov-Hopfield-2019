...
# learning rate
eps0 = 4e-2
# number of hidden units that are displayed in Ky by Kx array
Kx = 10
Ky = 10
'''
'''
...
history = output.fit(hid_output_train_rand, 
                     label_train_rand, 
                     epochs = 300, 
                     batch_size = 100, 
                     validation_data = (hid_output_test, label_test))
